        ...
        <div className="voting-situation-view">
            <header className="voting-situation-view__header">
                ...
                <div className="voting-situation-view__ctas">
                    <Button className="voting-situation-view__cta voting-situation-view__reject">Reject</Button>
                    <Button className="voting-situation-view__cta voting-situation-view__confirm">Confirm</Button>
                </div>
            </header>
            <div className="voting-situation-view__verification">
                ...
                <Button className="voting-situation-view__view-btn" onClick={() => setViewVerification(true)}>View</Button>
            </div>
            <PhotoSlider
                ...
                toolbarRender={({ onScale, scale, rotate, onRotate }) => {
                    return (
                        <>
                            <Image preview={false} src="/icon/zoom-in.svg" className="PhotoView-Slider__toolbarIcon" onClick={() => onScale(scale + 1)} />
                            <Image preview={false} src="/icon/zoom-out.svg" className="PhotoView-Slider__toolbarIcon" onClick={() => onScale(scale - 1)} />
                            <Image preview={false} src="/icon/rotate.svg" className="PhotoView-Slider__toolbarIcon" onClick={() => onRotate(rotate + 90)} />
                        </>
                    );
                }}
                overlayRender={overlayProps => {
                    return <div className="voting-situation-view__desc">{verificationType}</div>
                }}
            />
        </div>
    )
