...
const ProfilePayment = () => {
  ...
  return (
    <>
      ...
      />
      <div className="profile-edit-payment-wrapper">
        <div className="profile-edit-payment">
          <header className="profile-edit-payment__header">
          ...
          <div className="profile-edit-payment__divider" />
          <div className="profile-edit-payment__details">
            {paymentList.map((payment: any) => {
              return (
                <Card
                  ...
                  hoverable
                  style={{ width: 240 }}
                  className="profile-edit-payment__details__card"
                ...
                >
                  <div className="profile-edit-payment__details__info">
                    ...
                    >
                      <Radio
                        ...
                        className="profile-edit-payment__details__info__check"
                        onClick={() => {
