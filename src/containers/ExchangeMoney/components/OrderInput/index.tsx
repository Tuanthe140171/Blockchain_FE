        ...
        <div className="order-input">
            ...
            <div className="order-input__content">
                <div className="order-input__order-detail">
                    <Input className="order-input__input" value={orderId} onChange={(e: any) => setOrderId(e.target.value)}/>
                </div>
                <Button className="order-input__btn"
            ...
            {openDialog ? (
                <AppDialog
                    type="infor"
                    title={`Bạn đã mua thành công thành công ${new BigNumber(inputAmount).div(1e18).toFixed()} coin từ nhà phát hành`}
                    description=""
